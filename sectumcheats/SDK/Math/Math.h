...
public:
	...
	void HitchanceHelper(Vector angle, float *forward, float *right, float *up);
	...
	void CalcAngle(Vector src, Vector &dst);
	...
	void CalcAngle1(Vector src, Vector dst, Vector & angles);

	void VecAngles(Vector &forward, Vector &up, Vector &angle);
