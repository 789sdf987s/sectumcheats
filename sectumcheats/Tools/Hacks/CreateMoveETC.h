...
public:
	...
	static void LocalPrediction()
	{
		...
		else
		{
			...
			Interfaces.g_pMoveHelper = **reinterpret_cast< IMoveHelper*** >( Utils.PatternSearch( "client_panorama.dll", ( PBYTE )"\x8B\x0D\x00\x00\x00\x00\x8B\x46\x08\x68", "xx????xxxx", NULL, NULL ) + 0x2 );
		}
	}

	static void Bhop( Vector& OrigAng )
	{
